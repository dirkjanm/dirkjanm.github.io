...
* The [key usage](https://learn.microsoft.com/en-us/windows/client-management/mdm/clientcertificateinstall-csp#devicescepuniqueidinstallkeyusage). I'm not sure what the bit fields map to, I guess that is on MSDN somewhere, but most of the time it will be 160 in decimal which means both "digital signature" and "key encipherment".
